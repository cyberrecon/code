...
displayfiles: ['/interstitial/interstitial.txt'],

//2) display freqency: ["frequency_type", "frequency_value"]
displayfrequency: ["cookie", "5"],
// displayfrequency: ["chance", "1"],

//3) HTML for the header bar portion of the interstitial box
//defineheader: '<div class="headerbar"><a href="#" onClick="javascript:interstitialBox.closeit(); return false"><img src="/scripts/inter/closeit.gif" style="border: 0" title="Close Box"/></a></div>',
defineheader: '<div class="headerbar"><a href="http://www.dragondoor.com/kkb009.html?apid=4f1c7b34a7269&afsrc=1" target="_parent">Click here to visit Dragondoor.com</> or <a href="#" onClick="javascript:interstitialBox.closeit(); return false"><img src="/interstitial/closeit.gif" style="border: 0" title="Close Box"/></a></div>',
